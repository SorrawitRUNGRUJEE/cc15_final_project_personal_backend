...
router.post('/product/picture', authenticate, upload_middleware.array('productPicture',10),admin_controller.addProductPhoto)
router.delete('/product/picture',authenticate, admin_controller.deleteProductPhoto)
